...
{
    central_bbq_cooking_t *scr = central_bbq_cooking_get(ui);
    ...
    lv_img_set_src(scr->image_137, LVGL_IMAGE_PATH(bar.png));
    ...
    lv_obj_set_pos(scr->image_137, 115, 320);
    ...
    lv_label_set_text(scr->label_309, "烹饪中...");
    lv_label_set_long_mode(scr->label_309, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_309, 273, 157);
    lv_obj_set_size(scr->label_309, 235, 60);

    // Set style of scr->label_309
    lv_obj_set_style_text_font(scr->label_309, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(scr->image_138, LVGL_IMAGE_PATH(centralbbqicon.png));
    ...
    lv_obj_set_pos(scr->image_138, 115, 161);
