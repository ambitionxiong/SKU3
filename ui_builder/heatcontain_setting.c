...
{
    heatcontain_setting_t *scr = heatcontain_setting_get(ui);
    ...
    // Init scr->container_27
    scr->container_27 = lv_obj_create(scr->obj);
    lv_obj_set_pos(scr->container_27, 0, 0);
    lv_obj_set_size(scr->container_27, 1280, 480);
    lv_obj_set_scrollbar_mode(scr->container_27, LV_SCROLLBAR_MODE_OFF);

    // Set style of scr->container_27
    lv_obj_set_style_bg_color(scr->container_27, lv_color_hex(0x060505), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(scr->container_27, 113, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(scr->container_27, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(scr->container_27, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(scr->container_27, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(scr->container_27, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(scr->container_27, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(scr->container_27, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->image_270
    scr->image_270 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_270, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_270, 50, 50);
    lv_img_set_angle(scr->image_270, 0);
    lv_obj_set_style_img_opa(scr->image_270, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_270, 115, 115);

    // Init scr->label_614
    scr->label_614 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_614, "温度");
    lv_label_set_long_mode(scr->label_614, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_614, 242, 136);
    lv_obj_set_size(scr->label_614, 73, 30);

    // Set style of scr->label_614
    lv_obj_set_style_text_font(scr->label_614, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_614, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_614, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_615
    scr->label_615 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_615, "烹饪时间");
    lv_label_set_long_mode(scr->label_615, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_615, 454, 136);
    lv_obj_set_size(scr->label_615, 135, 30);

    // Set style of scr->label_615
    lv_obj_set_style_text_font(scr->label_615, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_615, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_615, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_620
    scr->label_620 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_620, "时");
    lv_label_set_long_mode(scr->label_620, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_620, 449, 229);
    lv_obj_set_size(scr->label_620, 37, 30);

    // Set style of scr->label_620
    lv_obj_set_style_text_font(scr->label_620, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_620, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_620, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_621
    scr->label_621 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_621, "分");
    lv_label_set_long_mode(scr->label_621, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_621, 612, 229);
    lv_obj_set_size(scr->label_621, 37, 30);

    // Set style of scr->label_621
    lv_obj_set_style_text_font(scr->label_621, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_621, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_621, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
