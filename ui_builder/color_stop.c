...
void color_stop_create(ui_manager_t *ui)
{
    ...
    lv_img_set_src(scr->image_10, LVGL_IMAGE_PATH(timer.png));
    ...
    lv_obj_set_pos(scr->image_10, 24, 24);

    // Init scr->label_12
    scr->label_12 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_12, "12:00");
    lv_label_set_long_mode(scr->label_12, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_12, 1197, 25);
    lv_obj_set_size(scr->label_12, 65, 32);
