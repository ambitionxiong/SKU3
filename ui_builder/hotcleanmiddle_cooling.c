...
{
    hotcleanmiddle_cooling_t *scr = hotcleanmiddle_cooling_get(ui);
    ...
    lv_img_set_src(scr->image_10, LVGL_IMAGE_PATH(hotcleanmiddleicon.png));
    ...
    lv_img_set_src(scr->image_11, LVGL_IMAGE_PATH(hotcleantips.png));
    ...
    lv_label_set_text(button_6_label, "");
    lv_obj_align(button_6_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_pos(scr->button_6, 609, 170);
    lv_obj_set_size(scr->button_6, 50, 43);

    // Set style of scr->button_6
    lv_obj_set_style_bg_opa(scr->button_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(scr->button_6, LVGL_IMAGE_PATH(lockicon.png), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(scr->button_6, fs_montserratmedium_16, LV_PART_MAIN | LV_STATE_DEFAULT);
