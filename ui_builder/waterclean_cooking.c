...
{
    waterclean_cooking_t *scr = waterclean_cooking_get(ui);
    ...
    lv_label_set_text(scr->label_6, "| 水解自清洁 | 10分钟 |");
    lv_label_set_long_mode(scr->label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_6, 274, 232);
    lv_obj_set_size(scr->label_6, 490, 39);

    // Set style of scr->label_6
    lv_obj_set_style_text_font(scr->label_6, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(scr->image_6, LVGL_IMAGE_PATH(watercleanicon.png));
