...
{
    central_bbq_menu_t *scr = central_bbq_menu_get(ui);
    ...
    lv_img_set_src(scr->image_130, LVGL_IMAGE_PATH(div2bk.png));
    ...
    lv_obj_set_pos(scr->image_130, 24, 118);

    // Init scr->image_131
    scr->image_131 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_131, LVGL_IMAGE_PATH(div2bk.png));
    ...
    lv_obj_set_pos(scr->image_131, 645, 118);

    // Init scr->label_281
    scr->label_281 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_281, "温度");
    lv_label_set_long_mode(scr->label_281, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_281, 300, 137);
    lv_obj_set_size(scr->label_281, 64, 32);

    // Set style of scr->label_281
    lv_obj_set_style_text_font(scr->label_281, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_281, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_283
    scr->label_283 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_283, "℃");
    lv_label_set_long_mode(scr->label_283, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_283, 372, 281);
    lv_obj_set_size(scr->label_283, 38, 32);

    // Set style of scr->label_283
    lv_obj_set_style_text_font(scr->label_283, fs_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_283, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_284
    scr->label_284 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_284, "烹饪时间");
    lv_label_set_long_mode(scr->label_284, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_284, 891, 137);
    lv_obj_set_size(scr->label_284, 125, 32);

    // Set style of scr->label_284
    lv_obj_set_style_text_font(scr->label_284, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_286, "时");
    lv_label_set_long_mode(scr->label_286, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_286, 872, 280);
    lv_obj_set_size(scr->label_286, 38, 32);

    // Set style of scr->label_286
    lv_obj_set_style_text_font(scr->label_286, fs_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_286, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_287
    scr->label_287 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_287, "分");
    lv_label_set_long_mode(scr->label_287, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_287, 1075, 281);
    lv_obj_set_size(scr->label_287, 38, 32);

    // Set style of scr->label_287
    lv_obj_set_style_text_font(scr->label_287, fs_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_287, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_289, "集中烧烤");
    lv_label_set_long_mode(scr->label_289, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_289, 24, 25);
    lv_obj_set_size(scr->label_289, 144, 32);

    // Set style of scr->label_289
    lv_obj_set_style_text_font(scr->label_289, fs_taiwanpearl_regular_24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_290, "下一步");
    lv_label_set_long_mode(scr->label_290, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_290, 996, 39);
    lv_obj_set_size(scr->label_290, 117, 32);

    // Set style of scr->label_290
    lv_obj_set_style_text_font(scr->label_290, fs_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
