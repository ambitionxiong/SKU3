...
{
    west_setting_t *scr = west_setting_get(ui);
    ...
    // Init scr->image_81
    scr->image_81 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_81, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_81, 50, 50);
    lv_img_set_angle(scr->image_81, 0);
    lv_obj_set_style_img_opa(scr->image_81, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_81, 115, 115);

    // Init scr->label_175
    scr->label_175 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_175, "温度");
    lv_label_set_long_mode(scr->label_175, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_175, 242, 136);
    lv_obj_set_size(scr->label_175, 73, 30);
    ...
    lv_obj_set_style_text_align(scr->label_175, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_176
    scr->label_176 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_176, "烹饪时间");
    lv_label_set_long_mode(scr->label_176, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_176, 454, 136);
    lv_obj_set_size(scr->label_176, 135, 30);
    ...
    lv_obj_set_style_text_align(scr->label_176, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_181, "时");
    lv_label_set_long_mode(scr->label_181, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_181, 449, 229);
    lv_obj_set_size(scr->label_181, 37, 30);

    // Set style of scr->label_181
    lv_obj_set_style_text_font(scr->label_181, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_181, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_181, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_182
    scr->label_182 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_182, "分");
    lv_label_set_long_mode(scr->label_182, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_182, 612, 229);
    lv_obj_set_size(scr->label_182, 37, 30);
    ...
    lv_obj_set_style_text_align(scr->label_182, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
