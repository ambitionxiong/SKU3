...
{
    unfrozen_setting_t *scr = unfrozen_setting_get(ui);
    ...
    scr->container_21 = lv_obj_create(scr->obj);
    lv_obj_set_pos(scr->container_21, 0, 0);
    lv_obj_set_size(scr->container_21, 1280, 480);
    lv_obj_set_scrollbar_mode(scr->container_21, LV_SCROLLBAR_MODE_OFF);

    // Set style of scr->container_21
    lv_obj_set_style_bg_color(scr->container_21, lv_color_hex(0x060505), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(scr->container_21, 113, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_207
    scr->image_207 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_207, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_207, 50, 50);
    lv_img_set_angle(scr->image_207, 0);
    lv_obj_set_style_img_opa(scr->image_207, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_207, 115, 115);

    // Init scr->label_467
    scr->label_467 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_467, "温度");
    lv_label_set_long_mode(scr->label_467, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_467, 242, 136);
    lv_obj_set_size(scr->label_467, 73, 30);

    // Set style of scr->label_467
    lv_obj_set_style_text_font(scr->label_467, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_467, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_467, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_468
    scr->label_468 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_468, "烹饪时间");
    lv_label_set_long_mode(scr->label_468, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_468, 454, 136);
    lv_obj_set_size(scr->label_468, 135, 30);

    // Set style of scr->label_468
    lv_obj_set_style_text_font(scr->label_468, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_468, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_468, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_473
    scr->label_473 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_473, "时");
    lv_label_set_long_mode(scr->label_473, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_473, 449, 229);
    lv_obj_set_size(scr->label_473, 37, 30);

    // Set style of scr->label_473
    lv_obj_set_style_text_font(scr->label_473, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_473, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_473, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_474
    scr->label_474 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_474, "分");
    lv_label_set_long_mode(scr->label_474, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_474, 612, 229);
    lv_obj_set_size(scr->label_474, 37, 30);

    // Set style of scr->label_474
    lv_obj_set_style_text_font(scr->label_474, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_474, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_474, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
