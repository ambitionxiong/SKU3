...
{
    corn_setting_t *scr = corn_setting_get(ui);
    ...
    scr->container_25 = lv_obj_create(scr->obj);
    lv_obj_set_pos(scr->container_25, 0, 0);
    lv_obj_set_size(scr->container_25, 1280, 480);
    lv_obj_set_scrollbar_mode(scr->container_25, LV_SCROLLBAR_MODE_OFF);

    // Set style of scr->container_25
    lv_obj_set_style_bg_color(scr->container_25, lv_color_hex(0x060505), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(scr->container_25, 113, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_249
    scr->image_249 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_249, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_249, 50, 50);
    lv_img_set_angle(scr->image_249, 0);
    lv_obj_set_style_img_opa(scr->image_249, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_249, 115, 115);

    // Init scr->label_565
    scr->label_565 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_565, "温度");
    lv_label_set_long_mode(scr->label_565, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_565, 242, 136);
    lv_obj_set_size(scr->label_565, 73, 30);

    // Set style of scr->label_565
    lv_obj_set_style_text_font(scr->label_565, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_565, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_565, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_566
    scr->label_566 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_566, "烹饪时间");
    lv_label_set_long_mode(scr->label_566, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_566, 454, 136);
    lv_obj_set_size(scr->label_566, 135, 30);

    // Set style of scr->label_566
    lv_obj_set_style_text_font(scr->label_566, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_566, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_566, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_571
    scr->label_571 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_571, "时");
    lv_label_set_long_mode(scr->label_571, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_571, 449, 229);
    lv_obj_set_size(scr->label_571, 37, 30);

    // Set style of scr->label_571
    lv_obj_set_style_text_font(scr->label_571, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_571, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_571, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_572
    scr->label_572 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_572, "分");
    lv_label_set_long_mode(scr->label_572, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_572, 612, 229);
    lv_obj_set_size(scr->label_572, 37, 30);

    // Set style of scr->label_572
    lv_obj_set_style_text_font(scr->label_572, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_572, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_572, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
