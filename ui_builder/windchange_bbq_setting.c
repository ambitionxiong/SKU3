...
{
    windchange_bbq_setting_t *scr = windchange_bbq_setting_get(ui);
    ...
    lv_img_set_src(scr->image_16, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_16, 50, 50);
    lv_img_set_angle(scr->image_16, 0);
    lv_obj_set_style_img_opa(scr->image_16, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_16, 115, 115);

    // Init scr->label_32
    scr->label_32 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_32, "温度");
    lv_label_set_long_mode(scr->label_32, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_32, 242, 136);
    lv_obj_set_size(scr->label_32, 73, 30);

    // Set style of scr->label_32
    lv_obj_set_style_text_font(scr->label_32, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_32, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_32, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_33
    scr->label_33 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_33, "烹饪时间");
    lv_label_set_long_mode(scr->label_33, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_33, 454, 136);
    lv_obj_set_size(scr->label_33, 135, 30);

    // Set style of scr->label_33
    lv_obj_set_style_text_font(scr->label_33, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_33, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_33, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_38, "时");
    lv_label_set_long_mode(scr->label_38, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_38, 449, 229);
    lv_obj_set_size(scr->label_38, 37, 30);

    // Set style of scr->label_38
    lv_obj_set_style_text_font(scr->label_38, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_38, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_38, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_39
    scr->label_39 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_39, "分");
    lv_label_set_long_mode(scr->label_39, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_39, 612, 229);
    lv_obj_set_size(scr->label_39, 37, 30);

    // Set style of scr->label_39
    lv_obj_set_style_text_font(scr->label_39, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_39, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_39, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
