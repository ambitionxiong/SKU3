...
void cookie_setting_create(ui_manager_t *ui)
{
    ...
    lv_obj_set_style_text_font(scr->label_132, &c_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(scr->label_133, &c_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
