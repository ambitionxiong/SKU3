...
{
    cookie_setting_t *scr = cookie_setting_get(ui);
    ...
    // Init scr->image_60
    scr->image_60 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_60, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_60, 50, 50);
    lv_img_set_angle(scr->image_60, 0);
    lv_obj_set_style_img_opa(scr->image_60, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_60, 115, 115);

    // Init scr->label_126
    scr->label_126 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_126, "温度");
    lv_label_set_long_mode(scr->label_126, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_126, 242, 136);
    lv_obj_set_size(scr->label_126, 73, 30);
    ...
    lv_obj_set_style_text_align(scr->label_126, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_127
    scr->label_127 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_127, "烹饪时间");
    lv_label_set_long_mode(scr->label_127, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_127, 454, 136);
    lv_obj_set_size(scr->label_127, 135, 30);
    ...
    lv_obj_set_style_text_align(scr->label_127, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_132
    scr->label_132 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_132, "时");
    lv_label_set_long_mode(scr->label_132, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_132, 449, 229);
    lv_obj_set_size(scr->label_132, 37, 30);

    // Set style of scr->label_132
    lv_obj_set_style_text_font(scr->label_132, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_132, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_132, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_133
    scr->label_133 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_133, "分");
    lv_label_set_long_mode(scr->label_133, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_133, 612, 229);
    lv_obj_set_size(scr->label_133, 37, 30);

    // Set style of scr->label_133
    lv_obj_set_style_text_font(scr->label_133, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_133, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_133, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
