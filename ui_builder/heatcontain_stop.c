...
{
    heatcontain_stop_t *scr = heatcontain_stop_get(ui);
    ...
    // Init scr->image_275
    scr->image_275 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_275, LVGL_IMAGE_PATH(bar.png));
    lv_img_set_pivot(scr->image_275, 50, 50);
    lv_img_set_angle(scr->image_275, 0);
    lv_obj_set_style_img_opa(scr->image_275, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_275, 115, 320);

    // Init scr->bar_45
    scr->bar_45 = lv_bar_create(scr->obj);
    lv_obj_set_style_anim_time(scr->bar_45, 0, 0);
    lv_bar_set_value(scr->bar_45, 2, LV_ANIM_OFF);
    lv_obj_set_pos(scr->bar_45, 122, 326);
    lv_obj_set_size(scr->bar_45, 637, 20);

    // Set style of scr->bar_45
    lv_obj_set_style_bg_color(scr->bar_45, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(scr->bar_45, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(scr->bar_45, lv_color_hex(0xffffff), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    // Init scr->label_625
    scr->label_625 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_625, "暂停中...");
    lv_label_set_long_mode(scr->label_625, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_625, 273, 157);
    lv_obj_set_size(scr->label_625, 235, 60);

    // Set style of scr->label_625
    lv_obj_set_style_text_font(scr->label_625, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_625, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_276
    scr->image_276 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_276, LVGL_IMAGE_PATH(heatcontainicon.png));
