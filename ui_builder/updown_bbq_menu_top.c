...
void updown_bbq_menu_top_create(ui_manager_t *ui)
{
    ...
    lv_img_set_src(scr->image_21, LVGL_IMAGE_PATH(preheatbg.png));
    ...
    lv_obj_add_flag(scr->label_50, LV_OBJ_FLAG_HIDDEN);   /* 同上,随按键一起隐藏 */
    ...
    lv_obj_set_style_text_font(scr->label_49, &c_taiwanpearl_regular_24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(scr->label_3, 682, 280);
