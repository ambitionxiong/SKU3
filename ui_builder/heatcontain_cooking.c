...
{
    heatcontain_cooking_t *scr = heatcontain_cooking_get(ui);
    ...
    // Init scr->image_268
    scr->image_268 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_268, LVGL_IMAGE_PATH(bar.png));
    lv_img_set_pivot(scr->image_268, 50, 50);
    lv_img_set_angle(scr->image_268, 0);
    lv_obj_set_style_img_opa(scr->image_268, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_268, 115, 320);

    // Init scr->bar_44
    scr->bar_44 = lv_bar_create(scr->obj);
    lv_obj_set_style_anim_time(scr->bar_44, 0, 0);
    lv_bar_set_value(scr->bar_44, 2, LV_ANIM_OFF);
    lv_obj_set_pos(scr->bar_44, 122, 326);
    lv_obj_set_size(scr->bar_44, 637, 20);

    // Set style of scr->bar_44
    lv_obj_set_style_bg_color(scr->bar_44, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(scr->bar_44, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(scr->bar_44, lv_color_hex(0xffffff), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    // Set style of scr->label_612
    lv_obj_set_style_text_font(scr->label_612, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_612, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_269
    scr->image_269 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_269, LVGL_IMAGE_PATH(heatcontainicon.png));
    lv_img_set_pivot(scr->image_269, 50, 50);
    lv_img_set_angle(scr->image_269, 0);
    lv_obj_set_style_img_opa(scr->image_269, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_269, 115, 161);
