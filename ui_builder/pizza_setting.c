...
{
    pizza_setting_t *scr = pizza_setting_get(ui);
    ...
    // Init scr->image_102
    scr->image_102 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_102, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_102, 50, 50);
    lv_img_set_angle(scr->image_102, 0);
    lv_obj_set_style_img_opa(scr->image_102, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_102, 115, 115);

    // Init scr->label_223
    scr->label_223 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_223, "温度");
    lv_label_set_long_mode(scr->label_223, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_223, 242, 136);
    lv_obj_set_size(scr->label_223, 73, 30);
    ...
    lv_obj_set_style_text_align(scr->label_223, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_224
    scr->label_224 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_224, "烹饪时间");
    lv_label_set_long_mode(scr->label_224, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_224, 454, 136);
    lv_obj_set_size(scr->label_224, 135, 30);
    ...
    lv_obj_set_style_text_align(scr->label_224, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_229, "时");
    lv_label_set_long_mode(scr->label_229, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_229, 449, 229);
    lv_obj_set_size(scr->label_229, 37, 30);

    // Set style of scr->label_229
    lv_obj_set_style_text_font(scr->label_229, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_229, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_229, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_230
    scr->label_230 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_230, "分");
    lv_label_set_long_mode(scr->label_230, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_230, 612, 229);
    lv_obj_set_size(scr->label_230, 37, 30);
    ...
    lv_obj_set_style_text_align(scr->label_230, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
