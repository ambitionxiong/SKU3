...
{
    air_setting_t *scr = air_setting_get(ui);
    ...
    lv_obj_set_pos(scr->container_15, 0, 0);
    lv_obj_set_size(scr->container_15, 1280, 480);
    lv_obj_set_scrollbar_mode(scr->container_15, LV_SCROLLBAR_MODE_OFF);

    // Set style of scr->container_15
    lv_obj_set_style_bg_color(scr->container_15, lv_color_hex(0x060505), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(scr->container_15, 113, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(scr->container_15, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(scr->container_15, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_144
    scr->image_144 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_144, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_144, 50, 50);
    lv_img_set_angle(scr->image_144, 0);
    lv_obj_set_style_img_opa(scr->image_144, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_144, 115, 115);

    // Init scr->label_320
    scr->label_320 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_320, "温度");
    lv_label_set_long_mode(scr->label_320, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_320, 242, 136);
    lv_obj_set_size(scr->label_320, 73, 30);

    // Set style of scr->label_320
    lv_obj_set_style_text_font(scr->label_320, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_320, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_320, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_321
    scr->label_321 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_321, "烹饪时间");
    lv_label_set_long_mode(scr->label_321, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_321, 454, 136);
    lv_obj_set_size(scr->label_321, 135, 30);

    // Set style of scr->label_321
    lv_obj_set_style_text_font(scr->label_321, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_321, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_321, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_326
    scr->label_326 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_326, "时");
    lv_label_set_long_mode(scr->label_326, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_326, 449, 229);
    lv_obj_set_size(scr->label_326, 37, 30);

    // Set style of scr->label_326
    lv_obj_set_style_text_font(scr->label_326, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_326, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_326, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_327
    scr->label_327 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_327, "分");
    lv_label_set_long_mode(scr->label_327, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_327, 612, 229);
    lv_obj_set_size(scr->label_327, 37, 30);

    // Set style of scr->label_327
    lv_obj_set_style_text_font(scr->label_327, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_327, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_327, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
