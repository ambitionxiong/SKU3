...
{
    hot_bbq_setting_t *scr = hot_bbq_setting_get(ui);
    ...
    // Init scr->image_86
    scr->image_86 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_86, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_86, 50, 50);
    lv_img_set_angle(scr->image_86, 0);
    lv_obj_set_style_img_opa(scr->image_86, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_86, 115, 115);

    // Init scr->label_187
    scr->label_187 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_187, "温度");
    lv_label_set_long_mode(scr->label_187, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_187, 242, 136);
    lv_obj_set_size(scr->label_187, 73, 30);

    // Set style of scr->label_187
    lv_obj_set_style_text_font(scr->label_187, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_187, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_187, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_188
    scr->label_188 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_188, "烹饪时间");
    lv_label_set_long_mode(scr->label_188, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_188, 454, 136);
    lv_obj_set_size(scr->label_188, 135, 30);

    // Set style of scr->label_188
    lv_obj_set_style_text_font(scr->label_188, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_188, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_188, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_193, "时");
    lv_label_set_long_mode(scr->label_193, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_193, 449, 229);
    lv_obj_set_size(scr->label_193, 37, 30);
    ...
    lv_obj_set_style_text_align(scr->label_193, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_194
    scr->label_194 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_194, "分");
    lv_label_set_long_mode(scr->label_194, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_194, 612, 229);
    lv_obj_set_size(scr->label_194, 37, 30);

    // Set style of scr->label_194
    lv_obj_set_style_text_font(scr->label_194, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_194, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_194, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
