...
void bottom_bbq_stop_create(ui_manager_t *ui)
{
    ...
    lv_obj_set_style_text_font(scr->label_150, &c_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(scr->littlebutton, &c_montserratmedium_16, LV_PART_MAIN | LV_STATE_DEFAULT);
