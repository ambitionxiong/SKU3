...
void slowcook_menu_probe_create(ui_manager_t *ui)
{
    ...
    lv_obj_set_style_text_font(scr->label_79, &c_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(scr->label_81, &c_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(scr->label_82, &c_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(scr->label_84, &c_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(scr->label_86, &c_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
