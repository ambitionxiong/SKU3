...
void jump_to_heatcontain_menu(void)
{
    ...
    if (menu) {
        ...
        nav_blink_extra(menu->temp, menu->label_585);
        nav_blink_extra(menu->hour, menu->label_588);
        nav_blink_extra(menu->min, menu->label_589);
...
void jump_to_heatcontain_setting(void)
{
    ...
    if (set) {
        ...
        nav_blink_extra(set->hour, set->label_620);
        nav_blink_extra(set->min, set->label_621);
