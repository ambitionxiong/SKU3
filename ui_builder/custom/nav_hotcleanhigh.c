...
void jump_to_hch_set(void)
{
    ...
    lv_scr_load_anim(hotcleanhigh_set_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hch_cooking(void)
{
    ...
    lv_scr_load_anim(hotcleanhigh_cooking_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hch_stop(void)
{
    ...
    lv_scr_load_anim(hotcleanhigh_stop_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hch_stop_back(void)
{
    ...
    if (back) {
        ...
        if (g_send.iface_status == IFACE_COOKING)
            lv_label_set_text(back->label_16, "烹饪中...");

        if (back->sure) lv_group_focus_obj(back->sure);
    }
    current_group = g_hch_stop_back;

    lv_scr_load_anim(hotcleanhigh_stop_back_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hch_cooling(void)
{
    ...
    lv_scr_load_anim(hotcleanhigh_cooling_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
    g_send.iface_status = IFACE_COOKING;
