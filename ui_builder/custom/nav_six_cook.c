...
static const six_bread_cfg_t s_bread_cfg[SIX_CAKE_MUFFIN + 1] = {
    /* 数值来源: SKU3惠而浦烤箱6th菜单菜谱-中英文-2026.xlsx（时长=预计烹饪时间,不含发酵45分钟） */
    /* 面包卷 */
    { "面包卷", MODE_UPDOWN_BBQ, 160, 22 * 60, {2, 4, 6}, 1, 1, 22,
      "烹饪说明：\n根据你最喜欢的食谱准备面团，放在烤盘上。\n现在将食物放在第3层。\n使用网架和盘。" },
    /* 全麦面包 */
    { "全麦面包", MODE_UPDOWN_BBQ, 180, 25 * 60, {2, 4, 6}, 1, 1, 25,
      "烹饪说明：\n根据你最喜欢的食谱准备面团，放在烤盘上。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 土司 */
    { "土司", MODE_UPDOWN_BBQ, 180, 45 * 60, {3, 6, 10}, 1, 1, 45,
      "烹饪说明：\n按照你喜欢的白面包配方准备面团，面团卷成长条状，并把它放在烤盘中。\n现在将食物放在第2层。\n使用网架和面包容器。" },
    /* 可颂(热风对流 windchange, 无烤色) */
    { "可颂", MODE_WINDCHANGE_BBQ, 180, 20 * 60, {0, 0, 0}, 0, 1, 20,
      "烹饪说明：\n根据你最喜欢的食谱准备面团，放在烤盘上。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 瑞士卷(蛋糕:上下烧烤, 无发酵无烤色) */
    { "瑞士卷", MODE_UPDOWN_BBQ, 160, 24 * 60, {0, 0, 0}, 0, 0, 24,
      "烹饪说明：\n准备500~900g无脂肪海绵蛋糕面糊。倒入铺了烹调纸并刷油的烤盘中。\n现在将食物放在第3层。\n使用网架和盘。" },
    /* 果馅卷(热风 hotwind, 无发酵无烤色) */
    { "果馅卷", MODE_HOTWIND_BBQ, 200, 30 * 60, {2, 4, 6}, 1, 0, 30,   /* 烤色 轻+2/中+4/深+6 */
      "烹饪说明：\n根据你喜欢的食谱准备面团，放在烤盘上。烹饪结束后，让它冷却下来，然后撒上糖粉。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 玛德琳(上下烧烤, 无发酵无烤色) */
    { "玛德琳", MODE_UPDOWN_BBQ, 180, 15 * 60, {0, 0, 0}, 0, 0, 15,
      "烹饪说明：\n根据你最喜欢的食谱准备和冷却面糊。将冷面糊直接倒入抹了油的玛德琳烤盘的中心。烹饪结束后，立即将盘倒在网架冷却架上，把玛德琳蛋糕放出来。放凉后再撒上糖粉，新鲜食用。\n现在将食物放在第3层。\n使用网架和蛋糕模具盘。" },
    /* 海绵蛋糕(上下烧烤, 无发酵无烤色) */
    { "海绵蛋糕", MODE_UPDOWN_BBQ, 180, 40 * 60, {3, 5, 10}, 1, 0, 40,   /* 烤色 轻+3/中+5/深+10 */
      "烹饪说明：\n准备无脂海绵蛋糕面糊500-900克。倒入涂了油的烤盘。\n现在将食物放在第2层。\n使用网架和模具盘。" },
    /* 纸杯蛋糕(上下烧烤, 无发酵无烤色) */
    { "纸杯蛋糕", MODE_UPDOWN_BBQ, 160, 25 * 60, {0, 0, 0}, 0, 0, 25,
      "烹饪说明：\n根据你喜欢的食谱准备面糊。将面糊均匀分布在烤盘的纸杯里，每个纸杯里填满2/3左右。烹饪结束后，转移到网架上完全冷却，然后再涂上糖霜。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 巧克力蛋糕(上下烧烤, 无发酵无烤色) */
    { "巧克力蛋糕", MODE_UPDOWN_BBQ, 160, 50 * 60, {0, 0, 0}, 0, 0, 50,
      "烹饪说明：\n准备500~900g巧克力蛋糕面糊。倒入铺了烹调纸并刷油的烤盘中。\n现在将食物放在第2层。\n使用网架和模具盘。" },
    /* 泡芙(上下烧烤, 无发酵无烤色) */
    { "泡芙", MODE_UPDOWN_BBQ, 180, 40 * 60, {0, 0, 0}, 0, 0, 40,
      "烹饪说明：\n根据你最喜欢的食谱准备面团。将2英寸的面团放到烤盘上。用潮湿的手指轻轻地按下尖的地方。在烹饪结束时，将泡芙转移到网架上，刺破每个泡芙的侧面或底部，释放困住的蒸汽。待其完全冷却后，将泡芙顶部的三分之一的位置切掉，倒入奶油，替换顶部。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 蛋挞(上下烧烤, 无发酵无烤色) */
    { "蛋挞", MODE_UPDOWN_BBQ, 230, 30 * 60, {0, 0, 0}, 0, 0, 30,
      "烹饪说明：\n根据你最喜欢的食谱准备面团和蛋奶冻。把面团分成相等的球。将每个部分压入模具中，从下向上形成一个边缘。将蛋奶液倒入酥皮中，填充80%左右。烹饪结束后，让它冷却后再食用。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 千层酥(热风 hotwind, 无发酵无烤色) */
    { "千层酥", MODE_HOTWIND_BBQ, 200, 24 * 60, {0, 0, 0}, 0, 0, 24,
      "烹饪说明：\n根据你喜欢的食谱准备酥皮和冰奶油。将酥皮放在烤盘上，撒上糖粉。烹饪结束时，将面皮切成3个大小相等的矩形。在最下面一层涂上冷冻的奶油，在顶部涂上第二层，再涂上一层奶油。小心地盖上涂了奶油的顶层，然后在食用前冷却。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 曲奇饼干(上下烧烤, 无发酵无烤色) */
    { "曲奇饼干", MODE_UPDOWN_BBQ, 160, 28 * 60, {0, 0, 0}, 0, 0, 28,
      "烹饪说明：\n根据你最喜欢的食谱准备面团。团出1.5汤匙大小的面团，放在烤盘上，每块饼干之间留出2.5厘米的空间。\n现在将食物放在第3层。\n使用烤盘。" },
    /* 松饼(上下烧烤, 无发酵无烤色) */
    { "松饼", MODE_UPDOWN_BBQ, 180, 25 * 60, {0, 0, 0}, 0, 0, 25,
...
int six_bread_has_color(void)  { return (six_chick_is_kind() || six_chick_is_seafood() || six_chick_is_veg() || six_chick_is_2d() || six_chick_is_pizza()) ? 0 : six_bread_cfg()->has_color; }   /* 烤鸡翅类/海鲜/蔬菜/二维菜/披萨:无烤色 */
int six_bread_has_rising(void) { return (six_chick_is_kind() || six_chick_is_seafood() || six_chick_is_veg() || six_chick_is_2d() || six_chick_is_pizza()) ? 0 : six_bread_cfg()->has_rising; }  /* 烤鸡翅类/海鲜/蔬菜/二维菜/披萨:无发酵 */
...
static int32_t six_cook_sec(void)
{
    ...
    if (six_chick_is_pizza()) {             /* 披萨:固定时长 */
        const seafood_dish_t *sd = pizza_fixed_cfg();
        return (sd ? sd->cook_min : 23) * 60;
    }
    if (six_chick_is_2d()) {                /* 二维菜:份量×程度 */
        return six_2d_cook_min() * 60;
    }
...
static void six_label_status(somecook_cooking_t *sc)
{
    if (six_chick_is_degree_time()) {
        ...
        lv_label_set_text_fmt(sc->label_12, tr("| %s | %d%s | %d分钟"),
                              six_chick_name(), w, toastcolor_weight_unit_n(w), six_chick_cook_min(w));   /* 烤鸡翅类:菜名+单位+时间 */
...
{
    if (six_chick_is_kind() || six_chick_is_seafood() || six_chick_is_veg() || six_chick_is_2d() || six_chick_is_pizza()) return six_chick_temp();
