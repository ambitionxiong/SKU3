...
void pizza_set_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_204, 163, 155);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_204, 100, 32);   /* 对齐 top_bbq 系排版 */
    ...
    lv_obj_set_pos(pg->label_206, 150, 270);   /* 对齐 top_bbq 系排版 */
