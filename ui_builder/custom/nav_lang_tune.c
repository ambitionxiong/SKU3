...
void air_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_337, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void air_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->timelabel, 250, 60);   /* 对齐 top_bbq 系排版 */
    ...
    lv_obj_set_size(pg->label_318, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void air_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_297, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_297, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_298: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 | 动态定位(需微调见文件头模板) */
    /* 位置由业务动态控制, 微调按文件头模板 */
    lv_obj_set_pos(pg->label_298, 1007, 41);
...
//     lv_obj_set_size(pg->label_306, 42, 32);
    ...
    lv_obj_set_size(pg->label_307, 220, 32);
    ...
    lv_obj_set_pos(pg->label_308, 784, 154);
    lv_obj_set_size(pg->label_308, 180, 32);

    /* label_309: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_309, 885, 270);
    lv_obj_set_size(pg->label_309, 100, 32);
    ...
    lv_obj_set_pos(pg->label_311, 765, 381);
    lv_obj_set_size(pg->label_311, 200, 32);
...
void air_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_331, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void air_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_333, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void bottom_bbq_complete_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_76, 350, 60);

    /* label_77: 标签 | "高温防烫" | (896,161) | 252x36 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_77, 800, 161);
    lv_obj_set_size(pg->label_77, 431, 36);
...
void bottom_bbq_cooking_probe_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->temp, 851, 156+5);
    lv_obj_set_size(pg->temp, 202, 60);
    ...
    lv_obj_set_size(pg->label_67, 280, 60);
...
void bottom_bbq_menu_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_50, 200, 32);

    /* label_51: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_51, 1010, 41);
...
void bottom_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_126, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_126, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_125, 30, 32);

      lv_obj_set_pos(pg->label_126, 448 + 21, 270);
      lv_obj_set_size(pg->label_126, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_125, 368 + 18, 270);
      lv_obj_set_size(pg->label_125, 30, 32);
...
void bottom_bbq_set_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_58, 225, 32);
    ...
    /* EN:仿 updown_set_probe 用"延/迟"文字标签替代中文 delaytext 图 */
    {
        static lv_obj_t *s_lb_yan = NULL, *s_lb_chi = NULL, *s_parent = NULL;
        if (s_parent != pg->obj) {   /* 同一页面重建后才重新创建,防重复叠加 */
            s_parent = pg->obj;
            s_lb_yan = lv_label_create(pg->obj);
            lv_label_set_text(s_lb_yan, tr("延"));
            lv_label_set_long_mode(s_lb_yan, LV_LABEL_LONG_WRAP);
            lv_obj_set_pos(s_lb_yan, 878, 154);
            lv_obj_set_size(s_lb_yan, 100, 32);
            lv_obj_set_style_text_font(s_lb_yan, &c_aktivgroteskmedium_30, LV_PART_MAIN | LV_STATE_DEFAULT);   /* EN:lang_tune 仅英文模式执行,直接用英文字体 */
            lv_obj_set_style_text_color(s_lb_yan, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            s_lb_chi = lv_label_create(pg->obj);
            lv_label_set_text(s_lb_chi, tr("迟"));
            lv_label_set_long_mode(s_lb_chi, LV_LABEL_LONG_WRAP);
            lv_obj_set_pos(s_lb_chi, 930, 154);
            lv_obj_set_size(s_lb_chi, 26, 32);
            lv_obj_set_style_text_font(s_lb_chi, &c_aktivgroteskmedium_30, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_color(s_lb_chi, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
        }
    }
...
void bottom_bbq_stop_back_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_72, 350, 60);
...
void bottom_bbq_stop_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_70, 350, 60);
...
void bread_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_763, 330, 60);   /* 对齐 top_bbq */
...
void bread_cooking_lang_tune(void)
{
    ...
    /* timelabel: 标签 | "00:19:59" | (907,157) | 235x60 | font taiwanpearl_regular_60 */
    lv_obj_set_pos(pg->timelabel, 907, 157);
    lv_obj_set_size(pg->timelabel, 250, 60);   /* 对齐 top_bbq */
    ...
    lv_obj_set_size(pg->label_748, 300, 60);   /* 对齐 top_bbq */
...
void bread_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_729, 1008, 41);
...
void bread_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_737, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_737, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_736, 30, 32);

      lv_obj_set_pos(pg->label_737, 448 + 21, 270);
      lv_obj_set_size(pg->label_737, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_736, 368 + 18, 270);
      lv_obj_set_size(pg->label_736, 30, 32);

    }
//     lv_obj_set_pos(pg->hour, 307, 254);
//     lv_obj_set_size(pg->hour, 80, 53);

//     /* min: 标签 | "20" | (395,254) | 58x53 | font taiwanpearl_regular_48 | 动态定位(默认业务值, 直接改数字) */
//     /* 位置由业务动态控制, 微调按文件头模板 */
//     lv_obj_set_size(pg->min, 90, 53);
...
//     lv_obj_set_size(pg->label_737, 64, 32);
    ...
    lv_obj_set_size(pg->label_738, 220, 32);
    ...
    lv_obj_set_pos(pg->label_739, 882, 154);
    lv_obj_set_size(pg->label_739, 100, 32);
    ...
    lv_obj_set_pos(pg->label_741, 714, 270);
...
void bread_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->min, 483, 214);   /* y 212→214 与 hour 对齐(此族 hour 仅 +2 不移 x) */
    lv_obj_set_size(pg->min, 102, 46);
...
void bread_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_757, 300, 60);   /* 对齐 top_bbq */
...
void bread_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_759, 330, 60);   /* 对齐 top_bbq */
...
void central_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_298, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_298, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_297, 30, 32);

      lv_obj_set_pos(pg->label_298, 448 + 21, 270);
      lv_obj_set_size(pg->label_298, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_297, 368 + 18, 270);
      lv_obj_set_size(pg->label_297, 30, 32);
...
void chickencooking_lang_tune(void)
{
    ...
    //lv_obj_set_style_bg_image_src(obj, LVGL_IMAGE_PATH(sku3_bg_delay_work_En.png), 0);
    ...
    obj = pg->text1;
    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_align(obj, LV_ALIGN_CENTER, 380, -65);
    obj = pg->text2;
    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_align(obj, LV_ALIGN_CENTER, 380, -27);
    // obj = pg->tip3;
    // lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    // lv_obj_align(obj, LV_ALIGN_CENTER, 380, 9);
...
void chip_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_845, 330, 60);   /* 对齐 top_bbq */
...
void chip_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_830, 300, 60);   /* 对齐 top_bbq */
...
void chip_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_811, 1008, 41);
...
void chip_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_819, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_819, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_818, 30, 32);

      lv_obj_set_pos(pg->label_819, 448 + 21, 270);
      lv_obj_set_size(pg->label_819, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_818, 368 + 18, 270);
      lv_obj_set_size(pg->label_818, 30, 32);
...
//     lv_obj_set_size(pg->label_819, 64, 32);
    ...
    lv_obj_set_size(pg->label_820, 220, 32);
    ...
    lv_obj_set_pos(pg->label_821, 882, 154);
    lv_obj_set_size(pg->label_821, 100, 32);
    ...
    lv_obj_set_pos(pg->label_823, 714, 270);
...
void chip_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_839, 300, 60);   /* 对齐 top_bbq */
...
void chip_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_841, 330, 60);   /* 对齐 top_bbq */
...
void color_cookoing_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->cooking_label, 300, 60);
...
void color_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_15, 300, 60);
...
void color_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_19, 600, 60);
...
void colorcooking_complete_lang_tune(void)
{
    ...
    lv_image_set_src(pg->image_3, LVGL_IMAGE_PATH(hotcare_en.png));
...
void cookie_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_143, 330, 60);   /* 对齐 top_bbq 系排版 */

    /* image_70: 图片 | (845,160) | img: hotcare.png */
    lv_obj_set_pos(pg->image_70, 820, 160);
    lv_image_set_src(pg->image_70, LVGL_IMAGE_PATH(hotcare_en.png));
...
void cookie_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_124, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void cookie_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_105, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_105, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_104, 30, 32);

      lv_obj_set_pos(pg->label_105, 448 + 21, 270);
      lv_obj_set_size(pg->label_105, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_104, 368 + 18, 270);
      lv_obj_set_size(pg->label_104, 30, 32);
...
//     lv_obj_set_size(pg->label_105, 64, 32);
    ...
    lv_obj_set_size(pg->label_106, 220, 32);
    ...
    lv_obj_set_pos(pg->label_108, 882, 154);
    lv_obj_set_size(pg->label_108, 100, 32);
    ...
    lv_obj_set_pos(pg->label_110, 714, 270);
...
void cookie_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_132, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_132, 37, 30);

    /* label_133: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_133, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void cookie_stop_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_137, 273, 157);
    lv_obj_set_size(pg->label_137, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void cookie_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_139, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void corn_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_582, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void corn_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_563, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void corn_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_542, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_542, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_543: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_543, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void corn_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_551, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_551, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_550, 30, 32);

      lv_obj_set_pos(pg->label_551, 448 + 21, 270);
      lv_obj_set_size(pg->label_551, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_550, 368 + 18, 270);
      lv_obj_set_size(pg->label_550, 30, 32);
...
//     /* 位置由业务动态控制, 微调按文件头模板 */
//     // lv_obj_set_pos(pg->min, 317, 258);
//     lv_obj_set_size(pg->min, 68, 66);   /* 对齐 air_set */
...
//     lv_obj_set_size(pg->label_551, 42, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_size(pg->label_552, 220, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_553, 784, 154);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_553, 180, 32);   /* 对齐 air_set */

    /* label_554: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_554, 885, 270);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_554, 100, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_556, 765, 381);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_556, 200, 32);   /* 对齐 air_set */
...
void corn_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_571, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_571, 37, 30);

    /* label_572: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_572, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void corn_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_576, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void corn_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_578, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void custom_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_886, 330, 60);   /* 对齐 top_bbq */
...
void custom_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_871, 300, 60);   /* 对齐 top_bbq */
...
void custom_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_852, 1008, 41);
...
void custom_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_860, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_860, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_859, 30, 32);

      lv_obj_set_pos(pg->label_860, 448 + 21, 270);
      lv_obj_set_size(pg->label_860, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_859, 368 + 18, 270);
      lv_obj_set_size(pg->label_859, 30, 32);
...
//     lv_obj_set_size(pg->label_860, 64, 32);
    ...
    lv_obj_set_size(pg->label_861, 220, 32);
    ...
    lv_obj_set_pos(pg->label_862, 882, 154);
    lv_obj_set_size(pg->label_862, 100, 32);
    ...
    lv_obj_set_pos(pg->label_864, 714, 270);
...
void custom_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_880, 300, 60);   /* 对齐 top_bbq */
...
void custom_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_882, 330, 60);   /* 对齐 top_bbq */
...
void delaycooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_14, 280, 60);
    ...
    lv_obj_set_pos(pg->tip1, 907-60, 158);
    lv_obj_set_size(pg->tip1, 350, 34);
    lv_label_set_text(pg->tip1,"Cooking");

    /* tip2: 标签 | "今明天12:00" | (907,194) | 230x34 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->tip2, 907-60, 194);
    lv_obj_set_size(pg->tip2, 350, 34);
    lv_label_set_text(pg->tip2,"will start");
...
void delayset_lang_tune(void)
{
    ...
    /* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Eng modify ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    lv_obj_t *obj = lv_screen_active();
    //lv_obj_set_style_bg_image_src(obj, LVGL_IMAGE_PATH(sku3_bg_delay_En.png), 0);
    ...
    obj = pg->start;
    // lv_obj_set_pos(obj, 827, 265);
    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_align(obj, LV_ALIGN_CENTER, 248, 51);

    lv_obj_t *cont = lv_obj_create(pg->obj);
    lv_obj_set_size(cont, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_set_style_bg_opa(cont, 0, 0);
    lv_obj_set_style_border_width(cont, 0, 0);
    lv_obj_set_style_radius(cont, 0, 0);
    lv_obj_set_style_pad_all(cont, 0, 0);
    lv_obj_align(cont, LV_ALIGN_CENTER, 0, 48);
    lv_obj_remove_flag(cont, LV_OBJ_FLAG_CLICKABLE);
    lv_obj_set_layout(cont, LV_LAYOUT_FLEX);
    lv_obj_set_flex_flow(cont, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(cont, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_END, LV_FLEX_ALIGN_START);
...
void descriptionmenu_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->cookdescriptin, 930, LV_SIZE_CONTENT);
    ...
    /* EN 行距 -2:aktivgrotesk_30 原生行高 32(中文 taiwanpearl_30 为 35),
     * 两条建页流程(nav_six_desc/nav_sixmenu)套用中文 -5 压缩后 EN 行距仅 27 会叠字;
     * -2 = 行距 30 与中文完全一致(中文仍走 layout 的 -5,行距 35-5=30 不变) */
    {
        lv_obj_t *lbls[] = { pg->cooktime, pg->cookdescriptin, pg->summary };
        for (int k = 0; k < 3; k++)
            if (lbls[k]) lv_obj_set_style_text_line_space(lbls[k], -2, 0);
    }
...
void duckmenu_lang_tune(void)
{
    ...
    if (six_chick_get_snack_mode() || six_chick_get_sidedish_mode() || six_chick_get_meatdish_mode()) {
        ...
        lv_obj_set_pos(pg->label_1, 24, 24);
        lv_obj_set_size(pg->label_1, 250, 25);
...
void extra_color_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->color_label, 600, 60);
...
void heatcontain_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_672, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void heatcontain_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_612, 450, 60);   /* 对齐 top_bbq 系排版 */
...
void heatcontain_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_591, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_591, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_592: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_592, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void heatcontain_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_600, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_600, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_599, 30, 32);

      lv_obj_set_pos(pg->label_600, 448 + 21, 270);
      lv_obj_set_size(pg->label_600, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_599, 368 + 18, 270);
      lv_obj_set_size(pg->label_599, 30, 32);
...
//     lv_obj_set_size(pg->label_600, 42, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_size(pg->label_601, 220, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_602, 784, 154);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_602, 180, 32);   /* 对齐 air_set */

    /* label_603: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_603, 885, 270);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_603, 100, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_605, 765, 381);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_605, 200, 32);   /* 对齐 air_set */
...
void heatcontain_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_620, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_620, 37, 30);

    /* label_621: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_621, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void heatcontain_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_625, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void hot_bbq_complete_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_43, 350, 60);

    /* label_44: 标签 | "高温防烫" | (896,161) | 252x36 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_44, 800, 161);
    lv_obj_set_size(pg->label_44, 431, 36);
...
void hot_bbq_cooking_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_34, 280, 60);
...
void hot_bbq_menu_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_5, 200, 32);

    /* label_6: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_6, 1010, 41);
...
void hot_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_174, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_174, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_173, 30, 32);

      lv_obj_set_pos(pg->label_174, 448 + 21, 270);
      lv_obj_set_size(pg->label_174, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_173, 368 + 18, 270);
      lv_obj_set_size(pg->label_173, 30, 32);
...
void hot_bbq_set_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_13, 225, 32);
    ...
    lv_obj_set_pos(pg->label_20, 1010, 41);
    ...
    lv_obj_add_flag(pg->image_3, LV_OBJ_FLAG_HIDDEN);   /* 延/迟标签已替代中文图 */
...
void hot_bbq_stop_back_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_39, 350, 60);
...
void hot_bbq_stop_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_37, 350, 60);
...
void hotwind_bbq_complete_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->image_112, 820, 160);
    lv_image_set_src(pg->image_112, LVGL_IMAGE_PATH(hotcare_en.png));
...
void hotwind_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_222, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_222, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_221, 30, 32);

      lv_obj_set_pos(pg->label_222, 448 + 21, 270);
      lv_obj_set_size(pg->label_222, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_221, 368 + 18, 270);
      lv_obj_set_size(pg->label_221, 30, 32);
...
void lasagna_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_681, 330, 60);
...
void lasagna_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_660, 300, 60);
...
void lasagna_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_641, 1008, 41);
...
void lasagna_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_649, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_649, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_648, 30, 32);

      lv_obj_set_pos(pg->label_649, 448 + 21, 270);
      lv_obj_set_size(pg->label_649, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_648, 368 + 18, 270);
      lv_obj_set_size(pg->label_648, 30, 32);
...
//     lv_obj_set_size(pg->label_649, 64, 32);
    ...
    lv_obj_set_size(pg->label_650, 220, 32);
    ...
    lv_obj_set_pos(pg->label_651, 882, 154);
    lv_obj_set_size(pg->label_651, 100, 32);
    ...
    lv_obj_set_pos(pg->label_653, 714, 270);
...
void lasagna_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_675, 300, 60);
...
void lasagna_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_677, 330, 60);
...
void menu_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_288, 330, 60);   /* 对齐 top_bbq 系排版 */

    /* image_133: 图片 | (845,160) | img: hotcare.png */
    lv_obj_set_pos(pg->image_133, 820, 160);
    lv_image_set_src(pg->image_133, LVGL_IMAGE_PATH(hotcare_en.png));
...
void menu_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_269, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void menu_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_249, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_249, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_250: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_250, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void menu_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_258, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_258, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_257, 30, 32);

      lv_obj_set_pos(pg->label_258, 448 + 21, 270);
      lv_obj_set_size(pg->label_258, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_257, 368 + 18, 270);
      lv_obj_set_size(pg->label_257, 30, 32);
...
//     lv_obj_set_size(pg->label_258, 64, 32);
    ...
    lv_obj_set_size(pg->label_259, 220, 32);
    ...
    /* 位置由业务动态控制, 微调按文件头模板 */
    lv_obj_set_pos(pg->label_260, 882, 154);
    lv_obj_set_size(pg->label_260, 100, 32);
    ...
    lv_obj_set_pos(pg->label_262, 714, 270);
...
void menu_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_277, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_277, 37, 30);

    /* label_278: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_278, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void menu_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_282, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void menu_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_284, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza3_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_804, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza3_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_789, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza3_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_770, 1008, 41);
...
void pizza3_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_778, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_778, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_777, 30, 32);

      lv_obj_set_pos(pg->label_778, 448 + 21, 270);
      lv_obj_set_size(pg->label_778, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_777, 368 + 18, 270);
      lv_obj_set_size(pg->label_777, 30, 32);
...
//     lv_obj_set_size(pg->label_778, 64, 32);
    ...
    lv_obj_set_size(pg->label_779, 220, 32);
    ...
    lv_obj_set_pos(pg->label_780, 882, 154);
    lv_obj_set_size(pg->label_780, 100, 32);
    ...
    lv_obj_set_pos(pg->label_782, 714, 270);
...
void pizza3_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_798, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza3_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_800, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_2_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_386, 330, 60);   /* 对齐 top_bbq 系排版 */

    /* image_175: 图片 | (845,160) | img: hotcare.png */
    lv_obj_set_pos(pg->image_175, 820, 160);
    lv_image_set_src(pg->image_175, LVGL_IMAGE_PATH(hotcare_en.png));
...
void pizza_2_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_367, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_2_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_346, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_346, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_347: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_347, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void pizza_2_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_355, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_355, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_354, 30, 32);

      lv_obj_set_pos(pg->label_355, 448 + 21, 270);
      lv_obj_set_size(pg->label_355, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_354, 368 + 18, 270);
      lv_obj_set_size(pg->label_354, 30, 32);
...
//     lv_obj_set_size(pg->label_355, 42, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_size(pg->label_356, 220, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_357, 784, 154);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_357, 180, 32);   /* 对齐 air_set */

    /* label_358: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_358, 885, 270);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_358, 100, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_360, 765, 381);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_360, 200, 32);   /* 对齐 air_set */
...
void pizza_2_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_375, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_375, 37, 30);

    /* label_376: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_376, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void pizza_2_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_380, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_2_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_382, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_240, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_221, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_201, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_201, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_202: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_202, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void pizza_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_210, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_210, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_209, 30, 32);

      lv_obj_set_pos(pg->label_210, 448 + 21, 270);
      lv_obj_set_size(pg->label_210, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_209, 368 + 18, 270);
      lv_obj_set_size(pg->label_209, 30, 32);
...
//     /* 位置由业务动态控制, 微调按文件头模板 */
//     // lv_obj_set_pos(pg->min, 317, 258);
//     lv_obj_set_size(pg->min, 90, 53);   /* 对齐 air_set */
...
//     lv_obj_set_size(pg->label_210, 64, 32);
    ...
    lv_obj_set_size(pg->label_211, 220, 32);
    ...
    lv_obj_set_pos(pg->label_212, 882, 154);
    lv_obj_set_size(pg->label_212, 100, 32);
    ...
    lv_obj_set_pos(pg->label_214, 714, 270);
...
void pizza_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_229, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_229, 37, 30);

    /* label_230: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_230, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void pizza_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_234, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void pizza_stop_back_lang_tune(void)
{
    ...
    /* label_236: 标签 | "暂停中..." | (273,157) | 235x60 | font taiwanpearl_regular_60 */
    lv_obj_set_pos(pg->label_236, 273, 157);
    lv_obj_set_size(pg->label_236, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void preheat_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->name, 370, 60);
...
void preheatcomplete_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->tip1, 915, 161);
    lv_obj_set_size(pg->tip1, 300, 29);

    /* tip2: 标签 | "选择相应模式！" | (917,197) | 210x29 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->tip2, 877, 197);
    lv_obj_set_size(pg->tip2, 450, 29);
...
void preheatcooking_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->temp, 934, 157);
    lv_obj_set_size(pg->temp, 180, 60);
...
static void preheatmenu_common(void)
{
    ...
    lv_obj_set_size(pg->label_61, 80, 32);

    /* temp: 标签 | "180" | (562,248) | 120x72 | font taiwanpearl_regular_72 */
    lv_obj_set_pos(pg->temp, 511, 251);
    lv_obj_set_size(pg->temp, 170, 72);
	...
	lv_img_set_src(pg->line3, LVGL_IMAGE_PATH(underline_179x4.png));
    lv_obj_set_pos(pg->line3, 555, 327);
	lv_obj_set_size(pg->line3, 164, 5);
...
void preheatstop_lang_tune(void)
{
    ...
    /* temp: 标签 | "180℃" | (940,157) | 159x60 | font taiwanpearl_regular_60 */
    lv_obj_set_pos(pg->temp, 934, 157);
    lv_obj_set_style_text_align(pg->temp, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN);
    lv_obj_set_size(pg->temp, 180, 60);
...
void probeneedtip_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->name, 24, 24);
    lv_obj_set_size(pg->name, 250, 25);
...
void rising_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_533, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void rising_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_514, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void rising_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_493, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_493, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_494: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_494, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void rising_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_502, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_502, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_501, 30, 32);

      lv_obj_set_pos(pg->label_502, 448 + 21, 270);
      lv_obj_set_size(pg->label_502, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_501, 368 + 18, 270);
      lv_obj_set_size(pg->label_501, 30, 32);
...
//     lv_obj_set_size(pg->label_502, 42, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_size(pg->label_503, 220, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_504, 784, 154);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_504, 180, 32);   /* 对齐 air_set */

    /* label_505: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_505, 885, 270);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_505, 100, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_507, 765, 381);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_507, 200, 32);   /* 对齐 air_set */
...
void rising_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_522, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_522, 37, 30);

    /* label_523: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_523, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void rising_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_527, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void rising_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_529, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void save_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_260, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_260, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_259, 30, 32);

      lv_obj_set_pos(pg->label_260, 448 + 21, 270);
      lv_obj_set_size(pg->label_260, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_259, 368 + 18, 270);
      lv_obj_set_size(pg->label_259, 30, 32);
...
void sixop3page_lang_tune(void)
{
    ...
    if (six_op3_get_kind() == SIX_OP3_KIND_MEAT_TZ) {
        ...
        lv_obj_set_size(pg->op3, 150+200, 30);
...
void slowcook_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_435, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void slowcook_complete_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_109, 350, 60);

    /* label_110/111: 英文面板 tips_en(431x88) 在 (820,160),标签框对齐面板宽,生成代码已是居中对齐 */
    lv_obj_set_pos(pg->label_110, 800, 161);
    lv_obj_set_size(pg->label_110, 431, 36);
...
void slowcook_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_416, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void slowcook_cooking_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_100, 280, 60);
...
void slowcook_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_395, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_395, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_396: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_396, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void slowcook_menu_probe_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_83, 24, 24);
    lv_obj_set_size(pg->label_83, 200, 32);

    /* label_84: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_84, 1010, 41);
...
void slowcook_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_404, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_404, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_403, 30, 32);

      lv_obj_set_pos(pg->label_404, 448 + 21, 270);
      lv_obj_set_size(pg->label_404, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_403, 368 + 18, 270);
      lv_obj_set_size(pg->label_403, 30, 32);
...
//     lv_obj_set_size(pg->label_404, 42, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_size(pg->label_405, 220, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_406, 784, 154);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_406, 180, 32);   /* 对齐 air_set */

    /* label_407: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_407, 885, 270);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_407, 100, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_409, 765, 381);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_409, 200, 32);   /* 对齐 air_set */
...
void slowcook_set_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_91, 225, 32);
    ...
    lv_obj_set_pos(pg->label_92, 1010, 41);
...
void slowcook_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_424, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_424, 37, 30);

    /* label_425: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_425, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void slowcook_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_429, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void slowcook_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_431, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void slowcook_stop_back_probe_lang_tune(void)
{
    ...
    /* 位置由业务动态控制, 微调按文件头模板 */
    lv_obj_set_size(pg->label_105, 350, 60);
...
void slowcook_stop_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_103, 350, 60);
...
static void somecook_cooking_common(void)
{
    ...
    /* text1: 标签 | "是否结束当前任务" | (895,160) | 252x36 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->text1, 895-170, 160);
    lv_obj_set_size(pg->text1, 600, 36);

    /* text2: 标签 | "回到主页" | (895,198) | 252x36 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->text2, 895-170, 198);
    lv_obj_set_size(pg->text2, 600, 36);
...
void strudel_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_722, 330, 60);   /* 对齐 top_bbq */
...
void strudel_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_707, 300, 60);   /* 对齐 top_bbq */
...
void strudel_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_688, 1008, 41);
...
void strudel_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_696, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_696, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_695, 30, 32);

      lv_obj_set_pos(pg->label_696, 448 + 21, 270);
      lv_obj_set_size(pg->label_696, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_695, 368 + 18, 270);
      lv_obj_set_size(pg->label_695, 30, 32);
...
//     lv_obj_set_size(pg->label_696, 64, 32);
    ...
    lv_obj_set_size(pg->label_697, 220, 32);
    ...
    lv_obj_set_pos(pg->label_698, 882, 154);
    lv_obj_set_size(pg->label_698, 100, 32);
    ...
    lv_obj_set_pos(pg->label_700, 714, 270);
...
void strudel_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_716, 300, 60);   /* 对齐 top_bbq */
...
void strudel_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_718, 330, 60);   /* 对齐 top_bbq */
...
void toastcolor_lang_tune(void)
{
    ...
    if (g_toast_mode == TOAST_MODE_WEIGHT) {
        ...
        lv_image_set_scale_x(pg->weightline3, 280);

        /* weightline4: 图片 | (530,328) | img: settingline3_179x4.png */
        lv_obj_set_pos(pg->weightline4, 530+20, 328);
        lv_image_set_scale_x(pg->weightline4, 280);
    ...
    //lv_obj_set_style_bg_image_src(obj, LVGL_IMAGE_PATH(sku3_bg_6_extralvl_En.png), 0);
    ...
    if (g_toast_mode == TOAST_MODE_WEIGHT) {
        ...
        // lv_obj_t *cont_1 = lv_obj_create(pg->obj);
        // lv_obj_remove_flag(cont_1, LV_OBJ_FLAG_CLICKABLE);
        // lv_obj_set_style_border_width(cont_1, 0, 0);
        // lv_obj_set_style_radius(cont_1, 0, 0);
        // lv_obj_set_width(cont_1, lv_obj_get_width(obj));
        // lv_obj_set_height(cont_1, 4);
        // lv_obj_set_style_bg_color(cont_1, lv_color_hex(0x000000), 0);
        // lv_obj_set_style_bg_opa(cont_1, LV_OPA_COVER, 0);
        // lv_obj_align_to(cont_1, obj, LV_ALIGN_OUT_BOTTOM_MID, 0, 4);
        /* weightline3: 图片 | (569,328) | img: settingline3_141x4.png */
        ...
        // lv_obj_set_style_border_width(cont, 0, 0);
        // lv_obj_set_style_radius(cont, 0, 0);
        // lv_obj_set_width(cont, lv_obj_get_width(obj));
        // lv_obj_set_height(cont, 4);
        // lv_obj_set_style_bg_color(cont, lv_color_hex(0x000000), 0);
        // lv_obj_set_style_bg_opa(cont, LV_OPA_COVER, 0);
        // lv_obj_align_to(cont, obj, LV_ALIGN_OUT_BOTTOM_MID, 0, 4);
        /* maturityline3: 图片 | (537,328) | img: settingline3_211x4.png */
...
void top_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_59, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_59, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_58, 30, 32);

      lv_obj_set_pos(pg->label_59, 448 + 21, 270);
      lv_obj_set_size(pg->label_59, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_58, 368 + 18, 270);
      lv_obj_set_size(pg->label_58, 30, 32);
...
void top_bbq_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_93, 450-1, 231);
    lv_obj_set_size(pg->label_93, 37, 30);

    /* label_94: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_94, 612+6, 231);
    lv_obj_set_size(pg->label_94, 37, 30);

    /* hourline: 图片 | (398,269) | img: settingline3.png */
    lv_obj_set_pos(pg->hourline, 398-3, 269);
    lv_image_set_scale_x(pg->hourline, 240);

    /* minline: 图片 | (560,269) | img: settingline3.png */
    lv_obj_set_pos(pg->minline, 560+15, 269);
    lv_image_set_scale_x(pg->minline, 335);
...
void unfrozen_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_484, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void unfrozen_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_465, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void unfrozen_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_444, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_444, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_445: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_445, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void unfrozen_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_453, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_453, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_452, 30, 32);

      lv_obj_set_pos(pg->label_453, 448 + 21, 270);
      lv_obj_set_size(pg->label_453, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_452, 368 + 18, 270);
      lv_obj_set_size(pg->label_452, 30, 32);
...
//     lv_obj_set_size(pg->label_453, 42, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_size(pg->label_454, 220, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_455, 784, 154);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_455, 180, 32);   /* 对齐 air_set */

    /* label_456: 标签 | "延" | (840,270) | 26x32 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_456, 885, 270);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_456, 100, 32);   /* 对齐 air_set */
    ...
    lv_obj_set_pos(pg->label_458, 765, 381);   /* 对齐 air_set */
    lv_obj_set_size(pg->label_458, 200, 32);   /* 对齐 air_set */
...
void unfrozen_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_473, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_473, 37, 30);

    /* label_474: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_474, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void unfrozen_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_478, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void unfrozen_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_480, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void updown_bbq_complete_probe_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->image_2, 820, 160);
    lv_image_set_src(pg->image_2, LVGL_IMAGE_PATH(hotcare_en.png));
...
void updown_bbq_cooking_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_66, 280, 60);
...
void updown_bbq_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->temeline_long, 252-7, 328);
    lv_image_set_scale_x(pg->temeline_long,290);

    /* templine_short: 图片 | (289,328) | img: underline_120x4.png */
    lv_obj_set_pos(pg->templine_short, 289, 328);

    /* hourline: 图片 | (790,328) | img: underline_120x4.png */
    lv_obj_set_pos(pg->hourline, 790-6, 328);
    lv_image_set_scale_x(pg->hourline, 235);

    /* minline: 图片 | (993,328) | img: underline_120x4.png */
    lv_obj_set_pos(pg->minline, 993+9, 328);
    lv_image_set_scale_x(pg->minline, 330);
...
void updown_bbq_menu_low_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_57, 996, 41);
    ...
    lv_obj_set_size(pg->temp, 150, 72);
...
void updown_bbq_menu_top_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_50, 996, 41);
...
void updown_bbq_set_lang_tune(void)
{
    ...
    /* preheat_button: 按钮 | (983,144) | 135x53 | font montserratmedium_16 | bg: off_en.png */
    lv_obj_set_pos(pg->preheat_button, 983, 144);
    lv_obj_set_size(pg->preheat_button, 135, 62);

    lv_obj_set_style_bg_img_src(pg->preheat_button, LVGL_IMAGE_PATH(off_en.png), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(pg->preheat_button, LVGL_IMAGE_PATH(focusoff_en.png), LV_PART_MAIN | LV_STATE_FOCUSED);
    ...
    lv_obj_set_size(pg->contain_button, 135, 62);
    ...
    /* preheat_on_button: 按钮 | (983,144) | 135x53 | font montserratmedium_16 | bg: on1_en.png */
    lv_obj_set_pos(pg->preheat_on_button, 983, 144);
    lv_obj_set_size(pg->preheat_on_button, 135, 62);

    lv_obj_set_style_bg_img_src(pg->preheat_on_button, LVGL_IMAGE_PATH(on1_en.png), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(pg->contain_on_button, 135, 62);
...
void updown_bbq_set_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_27, 225, 32);
    ...
    lv_obj_set_pos(pg->label_38, 1010, 41);
    ...
    lv_obj_set_pos(pg->label_2, 878, 154);
    ...
    lv_obj_add_flag(pg->image_2, LV_OBJ_FLAG_HIDDEN);
...
void updown_bbq_stop_probe_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_69, 280, 60);
...
void vegetablemenu_lang_tune(void)
{
    ...
    lv_obj_t *b16_lbl = lv_obj_get_child(pg->button_16, 0);
    if (b16_lbl) {
    lv_label_set_text(b16_lbl, "Grilled\nMixed Vegetables");
    /* 行内居中：每行文本在 label 内居中（默认是左对齐） */
    lv_obj_set_style_text_align(b16_lbl, LV_TEXT_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    /* 撑到按钮宽，保证两行都以按钮中心为基准居中 */
    lv_obj_set_width(b16_lbl, 310);
}
...
void waitmenu_24_lang_tune(void)
{
    ...
    //  lv_obj_set_style_bg_image_src(obj, LVGL_IMAGE_PATH(sku3_bg_standby_24_En.png), 0);
     ...
     obj = pg->time_label;
     lv_obj_set_style_text_font(obj, &c_aktivgroteskmedium_125, 0);
     lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
     lv_obj_align(obj, LV_ALIGN_CENTER, 0, -42);
     obj = pg->week_label;
     lv_obj_set_style_text_font(obj, &c_aktivgroteskmedium_48, 0);
     lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
...
void west_complete_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_192, 330, 60);   /* 对齐 top_bbq 系排版 */

    /* image_91: 图片 | (845,160) | img: hotcare.png */
    lv_obj_set_pos(pg->image_91, 820, 160);
    lv_image_set_src(pg->image_91, LVGL_IMAGE_PATH(hotcare_en.png));
...
void west_cooking_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_173, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void west_menu_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_152, 24, 24);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_152, 160, 32);   /* 对齐 top_bbq 系排版 */

    /* label_153: 标签 | "下一步" | (996,39) | 117x32 | font taiwanpearl_regular_36 */
    lv_obj_set_pos(pg->label_153, 1007, 41);   /* 对齐 top_bbq 系排版 */
...
void west_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_161, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_161, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_160, 30, 32);

      lv_obj_set_pos(pg->label_161, 448 + 21, 270);
      lv_obj_set_size(pg->label_161, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_160, 368 + 18, 270);
      lv_obj_set_size(pg->label_160, 30, 32);
...
//     lv_obj_set_size(pg->label_161, 64, 32);
    ...
    lv_obj_set_size(pg->label_162, 220, 32);
    ...
    lv_obj_set_pos(pg->label_164, 882, 154);
    lv_obj_set_size(pg->label_164, 100, 32);
    ...
    lv_obj_set_pos(pg->label_166, 714, 270);
...
void west_setting_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->label_181, 450, 231);   /* 对齐 top_bbq 系排版 */
    lv_obj_set_size(pg->label_181, 37, 30);

    /* label_182: 标签 | "分" | (612,229) | 37x30 | font taiwanpearl_regular_30 */
    lv_obj_set_pos(pg->label_182, 612, 231);   /* 对齐 top_bbq 系排版 */
...
void west_stop_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_186, 300, 60);   /* 对齐 top_bbq 系排版 */
...
void west_stop_back_lang_tune(void)
{
    ...
    lv_obj_set_size(pg->label_188, 330, 60);   /* 对齐 top_bbq 系排版 */
...
void windchange_bbq_complete_lang_tune(void)
{
    ...
    lv_obj_set_pos(pg->image_160, 820, 160);
    lv_image_set_src(pg->image_160, LVGL_IMAGE_PATH(hotcare_en.png));
...
void windchange_bbq_set_lang_tune(void)
{
    ...
    if (set_hour == 0) {                       // 无小时
      ...
      lv_obj_set_pos(pg->label_336, 368 + 21, 270 + 3);
      lv_obj_set_size(pg->label_336, 30, 32);
    } else {                                   // 有小时
      lv_obj_set_pos(pg->min, 395 + 29, 254 + 3);
      lv_obj_set_size(pg->label_335, 30, 32);

      lv_obj_set_pos(pg->label_336, 448 + 21, 270);
      lv_obj_set_size(pg->label_336, 42, 32);

      lv_obj_set_pos(pg->hour, 307 + 23, 254 + 3);
      lv_obj_set_size(pg->hour, 62, 53);

      lv_obj_set_pos(pg->label_335, 368 + 18, 270);
      lv_obj_set_size(pg->label_335, 30, 32);
...
void sixset2_lang_tune(void)
{
    ...
    if (six_chick_is_matdeg()) {
        ...
        lv_obj_set_pos(pg->weightline4, 223+20, 328);
        lv_image_set_scale_x(pg->weightline4, 270);
        lv_obj_set_pos(pg->weightline3, 260, 328);
        lv_image_set_scale_x(pg->weightline3, 275);
    }
    ...
    lv_obj_t *obj = NULL;
    obj = lv_screen_active();
    //lv_obj_set_style_bg_image_src(obj, LVGL_IMAGE_PATH(sku3_bg_6_set_2.png), 0);
    ...
    obj = pg->label_19;
    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_align_to(obj, pg->next, LV_ALIGN_CENTER, 0, 0);

    obj = pg->name1;
    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_align_to(obj, pg->image_1, LV_ALIGN_CENTER, -4, -132);

    obj = pg->label_13;
    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_align_to(obj, pg->image_2, LV_ALIGN_CENTER, -2, -132);
    ...
    if (six_chick_is_matdeg()) {
        ...
        lv_obj_set_style_radius(cont, 0, 0);
        lv_obj_set_style_pad_all(cont, 0, 0);
        lv_obj_align(cont, LV_ALIGN_CENTER, -1, 1);
        lv_obj_remove_flag(cont, LV_OBJ_FLAG_CLICKABLE);
        lv_obj_set_layout(cont, LV_LAYOUT_FLEX);
        lv_obj_set_flex_flow(cont, LV_FLEX_FLOW_ROW);
        lv_obj_set_flex_align(cont, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
