...
void jump_to_cake6menu(void)
{
    ...
    if (ck) {
        ...
        lv_obj_add_event_cb(ck->swissroll, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_SWISSROLL);
        lv_obj_add_event_cb(ck->strudel, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_STRUDEL);
        lv_obj_add_event_cb(ck->muffin, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_MUFFIN);
        lv_obj_add_event_cb(ck->madeleine, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_MADELEINE);
        lv_obj_add_event_cb(ck->spongecake, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_SPONGECAKE);
        lv_obj_add_event_cb(ck->cupcake, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_CUPCAKE);
        lv_obj_add_event_cb(ck->chocolatecake, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_CHOCOLATECAKE);
        lv_obj_add_event_cb(ck->creampuff, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_CREAMPUFF);
        lv_obj_add_event_cb(ck->eggtart, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_EGGTART);
        lv_obj_add_event_cb(ck->millefeuille, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_MILLEFEUILLE);
        lv_obj_add_event_cb(ck->cookies, on_cake6menu_click, LV_EVENT_CLICKED, (void *)(intptr_t)SIX_CAKE_COOKIES);
        lv_group_focus_obj(ck->swissroll);
    }
