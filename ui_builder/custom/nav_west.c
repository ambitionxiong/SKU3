...
void jump_to_west_set(void)
{
    ...
    if (set) {
        ...
        g_west_set = group_create_for_page(btns, 7);
        ...
        lv_obj_add_event_cb(set->offcontain, west_preheat_toggle, LV_EVENT_CLICKED, NULL);
        lv_obj_add_event_cb(set->oncontain, west_preheat_toggle, LV_EVENT_CLICKED, NULL);
        lv_obj_add_event_cb(set->offcontain, west_delay_toggle, LV_EVENT_CLICKED, NULL);
        lv_obj_add_event_cb(set->oncontain, west_delay_toggle, LV_EVENT_CLICKED, NULL);
