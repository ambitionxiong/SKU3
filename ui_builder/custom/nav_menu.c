...
void jump_to_menu_menu(void)
{
    ...
    lv_scr_load_anim(menu_menu_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
        g_send.cook_mode = MODE_COOK4;
...
void jump_to_menu_cooking(void)
{
    ...
    lv_scr_load_anim(menu_cooking_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_menu_stop(void)
{
    ...
    lv_scr_load_anim(menu_stop_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_menu_stop_back(void)
{
    ...
    lv_scr_load_anim(menu_stop_back_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
