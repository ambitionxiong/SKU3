...
int is_menu_edit_page(page_id_t cur);      /* 各模式 MENU 菜单设置页(编辑字段族,进页即浏览) */
...
int six_chick_get_fish_mode(void);
...
extern int six_rising_min(void);
...
#define SIX_SNACK_FRIES         38  /* 炸薯条（份量驱动） */
#define SIX_VEG_POTATO_CHIP     39  /* 烤土豆片（固定参数） */
