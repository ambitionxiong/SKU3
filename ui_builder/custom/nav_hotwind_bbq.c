...
void jump_to_hotwind_bbq_menu(void)
{
    ...
    lv_scr_load_anim(hotwind_bbq_menu_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hotwind_bbq_set(void)
{
    ...
    lv_scr_load_anim(hotwind_bbq_set_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hotwind_bbq_cooking(void)
{
    ...
    lv_scr_load_anim(hotwind_bbq_cooking_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hotwind_bbq_setting(void)
{
    ...
    lv_scr_load_anim(hotwind_bbq_setting_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_hotwind_bbq_stop(void)
{
    ...
    lv_scr_load_anim(hotwind_bbq_stop_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
