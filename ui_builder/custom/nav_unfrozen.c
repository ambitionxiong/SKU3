...
void jump_to_unfrozen_menu(void)
{
    ...
    if (menu) {
        ...
        nav_blink_extra(menu->temp, menu->label_438);
        nav_blink_extra(menu->hour, menu->label_441);
        nav_blink_extra(menu->min, menu->label_442);
    ...
    lang_scr_load_anim(unfrozen_menu_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_unfrozen_set(void)
{
    ...
    lang_scr_load_anim(unfrozen_set_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_unfrozen_cooking(void)
{
    ...
    lang_scr_load_anim(unfrozen_cooking_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_unfrozen_setting(void)
{
    ...
    if (set) {
        ...
        nav_blink_extra(set->hour, set->label_473);
        nav_blink_extra(set->min, set->label_474);
    ...
    lang_scr_load_anim(unfrozen_setting_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_unfrozen_stop(void)
{
    ...
    lang_scr_load_anim(unfrozen_stop_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
...
void jump_to_unfrozen_stop_back(void)
{
    ...
    if (back) {
        ...
        if (g_delay_cancel_to_stop_back) {
            ...
            lv_label_set_text(back->label_482, g_delay_cancel_btn ? tr("回到上一页") : tr("回到主页"));
    ...
    lang_scr_load_anim(unfrozen_stop_back_get(&ui_manager)->obj,
                     LV_SCR_LOAD_ANIM_NONE, 0, 0,
                     ui_manager.auto_del);
