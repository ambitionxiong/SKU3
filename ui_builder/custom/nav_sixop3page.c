...
/* bt 按钮点击：暂留空（TODO:接入各菜谱流程） */
static void on_sixop3page_bt1_click(lv_event_t *e) { (void)e; }
static void on_sixop3page_bt2_click(lv_event_t *e) { (void)e; }
static void on_sixop3page_bt3_click(lv_event_t *e) { (void)e; }
