...
{
    hot_bbq_cooking_probe_t *scr = hot_bbq_cooking_probe_get(ui);
    ...
    lv_img_set_src(scr->image_8, LVGL_IMAGE_PATH(hotbbqicon.png));
    ...
    // Init scr->label_34
    scr->label_34 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_34, "烹饪中...");
    lv_label_set_long_mode(scr->label_34, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_34, 273, 157);
    ...
    lv_img_set_src(scr->image_9, LVGL_IMAGE_PATH(probeicon.png));
    ...
    lv_obj_set_pos(scr->image_9, 1068, 180);
