...
void color_cookoing_create(ui_manager_t *ui)
{
    ...
    lv_label_set_text(stop_button_label, "");
    ...
    lv_obj_set_style_bg_img_src(scr->stop_button, LVGL_IMAGE_PATH(stop.png), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(scr->stop_button, fs_montserratmedium_16, LV_PART_MAIN | LV_STATE_DEFAULT);
