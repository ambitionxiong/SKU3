...
{
    hot_bbq_stop_back_probe_t *scr = hot_bbq_stop_back_probe_get(ui);
    ...
    lv_img_set_src(scr->image_13, LVGL_IMAGE_PATH(bar.png));
    ...
    lv_obj_set_pos(scr->image_13, 115, 320);
    ...
    lv_img_set_src(scr->image_14, LVGL_IMAGE_PATH(hotbbqicon.png));
    ...
    lv_obj_set_pos(scr->image_14, 115, 161);

    // Init scr->label_39
    scr->label_39 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_39, "暂停中...");
    lv_label_set_long_mode(scr->label_39, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_39, 273, 157);
    lv_obj_set_size(scr->label_39, 235, 60);

    // Set style of scr->label_39
    lv_obj_set_style_text_font(scr->label_39, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->label_40
    scr->label_40 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_40, "是否结束当前任务");
    lv_label_set_long_mode(scr->label_40, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_40, 895, 160);
    lv_obj_set_size(scr->label_40, 252, 36);

    // Set style of scr->label_40
    lv_obj_set_style_text_font(scr->label_40, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_40, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_40, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_41
    scr->label_41 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_41, "回到主页");
    lv_label_set_long_mode(scr->label_41, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_41, 895, 198);
    lv_obj_set_size(scr->label_41, 252, 36);
    ...
    lv_obj_set_style_text_align(scr->label_41, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
