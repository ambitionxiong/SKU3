...
{
    updown_bbq_menu_probe_t *scr = updown_bbq_menu_probe_get(ui);
    ...
    lv_img_set_src(scr->image_3, LVGL_IMAGE_PATH(div2bk.png));
    ...
    lv_obj_set_pos(scr->image_3, 24, 118);

    // Init scr->image_4
    scr->image_4 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_4, LVGL_IMAGE_PATH(div2bk.png));
    ...
    lv_obj_set_pos(scr->image_4, 645, 118);

    // Init scr->label_4
    scr->label_4 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_4, "温度");
    lv_label_set_long_mode(scr->label_4, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_4, 300, 137);
    lv_obj_set_size(scr->label_4, 64, 32);
    ...
    lv_label_set_text(scr->label_6, "℃");
    lv_label_set_long_mode(scr->label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_6, 372, 281);
    ...
    lv_label_set_text(scr->label_7, "探针温度");
    lv_label_set_long_mode(scr->label_7, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_7, 891, 137);
    lv_obj_set_size(scr->label_7, 125, 32);
    ...
    lv_label_set_text(scr->label_12, "上下烧烤");
    lv_label_set_long_mode(scr->label_12, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_12, 24, 25);
    lv_obj_set_size(scr->label_12, 144, 32);

    // Set style of scr->label_12
    lv_obj_set_style_text_font(scr->label_12, &c_taiwanpearl_regular_24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_13, "下一步");
    lv_label_set_long_mode(scr->label_13, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_13, 996, 39);
    lv_obj_set_size(scr->label_13, 117, 32);

    // Set style of scr->label_13
    lv_obj_set_style_text_font(scr->label_13, &c_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_15, "℃");
    lv_label_set_long_mode(scr->label_15, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_15, 973, 281);
    lv_obj_set_size(scr->label_15, 38, 32);

    // Set style of scr->label_15
    lv_obj_set_style_text_font(scr->label_15, &c_taiwanpearl_regular_36, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_15, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->probeline2
    scr->probeline2 = lv_img_create(scr->obj);
    lv_img_set_src(scr->probeline2, LVGL_IMAGE_PATH(underline_120x4.png));
    lv_img_set_pivot(scr->probeline2, 50, 50);
    lv_img_set_angle(scr->probeline2, 0);
    lv_obj_set_style_img_opa(scr->probeline2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->probeline2, 891, 328);
    lv_obj_add_flag(scr->probeline2, LV_OBJ_FLAG_HIDDEN);
