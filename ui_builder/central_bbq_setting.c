...
{
    central_bbq_setting_t *scr = central_bbq_setting_get(ui);
    ...
    lv_img_set_src(scr->image_11, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_11, 50, 50);
    lv_img_set_angle(scr->image_11, 0);
    lv_obj_set_style_img_opa(scr->image_11, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_11, 115, 115);

    // Init scr->label_22
    scr->label_22 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_22, "温度");
    lv_label_set_long_mode(scr->label_22, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_22, 242, 136);
    lv_obj_set_size(scr->label_22, 73, 30);
    ...
    lv_label_set_text(scr->label_23, "烹饪时间");
    lv_label_set_long_mode(scr->label_23, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_23, 454, 136);
    lv_obj_set_size(scr->label_23, 135, 30);
    ...
    lv_label_set_text(scr->label_28, "时");
    lv_label_set_long_mode(scr->label_28, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_28, 449, 229);
    lv_obj_set_size(scr->label_28, 37, 30);
    ...
    // Init scr->label_29
    scr->label_29 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_29, "分");
    lv_label_set_long_mode(scr->label_29, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_29, 612, 229);
    lv_obj_set_size(scr->label_29, 37, 30);

    // Set style of scr->label_29
    lv_obj_set_style_text_font(scr->label_29, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_29, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
