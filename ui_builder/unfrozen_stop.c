...
{
    unfrozen_stop_t *scr = unfrozen_stop_get(ui);
    ...
    // Init scr->image_212
    scr->image_212 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_212, LVGL_IMAGE_PATH(bar.png));
    lv_img_set_pivot(scr->image_212, 50, 50);
    lv_img_set_angle(scr->image_212, 0);
    lv_obj_set_style_img_opa(scr->image_212, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_212, 115, 320);

    // Init scr->bar_33
    scr->bar_33 = lv_bar_create(scr->obj);
    lv_obj_set_style_anim_time(scr->bar_33, 0, 0);
    lv_bar_set_value(scr->bar_33, 2, LV_ANIM_OFF);
    ...
    // Init scr->label_478
    scr->label_478 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_478, "暂停中...");
    lv_label_set_long_mode(scr->label_478, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_478, 273, 157);
    lv_obj_set_size(scr->label_478, 235, 60);

    // Set style of scr->label_478
    lv_obj_set_style_text_font(scr->label_478, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_478, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_213
    scr->image_213 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_213, LVGL_IMAGE_PATH(unfrozenicon.png));
