...
{
    central_bbq_stop_t *scr = central_bbq_stop_get(ui);
    ...
    lv_img_set_src(scr->image_139, LVGL_IMAGE_PATH(bar.png));
    ...
    lv_obj_set_pos(scr->image_139, 115, 320);

    // Init scr->bar_27
    scr->bar_27 = lv_bar_create(scr->obj);
    lv_obj_set_style_anim_time(scr->bar_27, 0, 0);
    lv_bar_set_value(scr->bar_27, 2, LV_ANIM_OFF);
    ...
    // Init scr->label_312
    scr->label_312 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_312, "暂停中...");
    lv_label_set_long_mode(scr->label_312, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_312, 273, 157);
    lv_obj_set_size(scr->label_312, 235, 60);

    // Set style of scr->label_312
    lv_obj_set_style_text_font(scr->label_312, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_312, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_140
    scr->image_140 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_140, LVGL_IMAGE_PATH(centralbbqicon.png));
    lv_img_set_pivot(scr->image_140, 50, 50);
    lv_img_set_angle(scr->image_140, 0);
    lv_obj_set_style_img_opa(scr->image_140, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_140, 115, 161);
