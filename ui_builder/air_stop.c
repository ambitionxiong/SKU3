...
{
    air_stop_t *scr = air_stop_get(ui);
    ...
    // Init scr->image_149
    scr->image_149 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_149, LVGL_IMAGE_PATH(bar.png));
    lv_img_set_pivot(scr->image_149, 50, 50);
    lv_img_set_angle(scr->image_149, 0);
    lv_obj_set_style_img_opa(scr->image_149, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_149, 115, 320);

    // Init scr->bar_21
    scr->bar_21 = lv_bar_create(scr->obj);
    lv_obj_set_style_anim_time(scr->bar_21, 0, 0);
    lv_bar_set_value(scr->bar_21, 2, LV_ANIM_OFF);
    ...
    lv_label_set_text(scr->label_331, "暂停中...");
    lv_label_set_long_mode(scr->label_331, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_331, 273, 157);
    lv_obj_set_size(scr->label_331, 235, 60);

    // Set style of scr->label_331
    lv_obj_set_style_text_font(scr->label_331, fs_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Init scr->image_150
    scr->image_150 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_150, LVGL_IMAGE_PATH(airicon.png));
    lv_img_set_pivot(scr->image_150, 50, 50);
    lv_img_set_angle(scr->image_150, 0);
    lv_obj_set_style_img_opa(scr->image_150, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_150, 115, 161);
