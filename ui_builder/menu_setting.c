...
{
    menu_setting_t *scr = menu_setting_get(ui);
    ...
    // Init scr->image_123
    scr->image_123 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_123, LVGL_IMAGE_PATH(settingbk.png));
    lv_img_set_pivot(scr->image_123, 50, 50);
    lv_img_set_angle(scr->image_123, 0);
    lv_obj_set_style_img_opa(scr->image_123, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_123, 115, 115);

    // Init scr->label_271
    scr->label_271 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_271, "温度");
    lv_label_set_long_mode(scr->label_271, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_271, 242, 136);
    lv_obj_set_size(scr->label_271, 73, 30);

    // Set style of scr->label_271
    lv_obj_set_style_text_font(scr->label_271, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_271, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_271, 2, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Init scr->label_272
    scr->label_272 = lv_label_create(scr->obj);
    lv_label_set_text(scr->label_272, "烹饪时间");
    lv_label_set_long_mode(scr->label_272, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_272, 454, 136);
    lv_obj_set_size(scr->label_272, 135, 30);

    // Set style of scr->label_272
    lv_obj_set_style_text_font(scr->label_272, fs_taiwanpearl_regular_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(scr->label_272, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(scr->label_272, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(scr->label_277, "时");
    lv_label_set_long_mode(scr->label_277, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_277, 449, 229);
    lv_obj_set_size(scr->label_277, 37, 30);
    ...
    lv_label_set_text(scr->label_278, "分");
    lv_label_set_long_mode(scr->label_278, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(scr->label_278, 612, 229);
    lv_obj_set_size(scr->label_278, 37, 30);
