...
{
    cookie_stop_t *scr = cookie_stop_get(ui);
    ...
    // Init scr->image_65
    scr->image_65 = lv_img_create(scr->obj);
    lv_img_set_src(scr->image_65, LVGL_IMAGE_PATH(bar.png));
    lv_img_set_pivot(scr->image_65, 50, 50);
    lv_img_set_angle(scr->image_65, 0);
    lv_obj_set_style_img_opa(scr->image_65, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_pos(scr->image_65, 115, 320);
    ...
    lv_label_set_text(scr->label_137, "暂停中...");
    ...
    lv_obj_set_style_text_font(scr->label_137, &c_taiwanpearl_regular_60, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(scr->image_66, LVGL_IMAGE_PATH(cookieicon.png));
    ...
    lv_obj_set_pos(scr->image_66, 115, 161);
